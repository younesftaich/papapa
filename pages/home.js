...
const home = () => {
  ...
  <div className="space-y-4  md:space-y-6 overflow-hidden">
    <div className="py-8 px-12 sm:pb-14 md:pb-16 lg:pb-20">
      <div className="grid grid-cols-2 nf-container items-center">
      ...
      <div className="nf-container grid grid-cols-1 md:grid-cols-3 gap-6 pt-8 sm:pt-14 md:pt-16 lg:pt-20">
      ...
      <div className="nf-container text-center pt-8 sm:pt-14 md:pt-16 lg:pt-20">
    ...
    <div className="nf-container py-14 px-6 md:py-16 lg:py-20">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center">
    ...
    <div className="bg-gray-50 py-14 md:py-16 lg:py-20 bg-hideout-type-2" style={{border: '3px solid #ecf0fa'}}>
      <div className="md:px-9 px-0 max-w-7xl mx-auto nf-container">
    ...
    <div className="md:px-9 px-6 max-w-7xl mx-auto nf-container py-14 md:py-16 lg:py-20">
      <div className="pb-6">
