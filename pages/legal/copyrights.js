  ...
  <div className="nf-container px-12">
    ...
    <div className="leading-8 pb-12">
      ...
      <ul className="text-sm">
        ...
        <li>Identification of the copyrighted works claimed to have been infringed on LUX TV’s website or the LUX TV service, or if multiple copyrighted works are covered by a single notification, a representative list of such works.</li>
        <li>Identification of the material that is claimed to be infringing or to be the subject of infringing activity and that is to be removed or access to which is to be disabled, and information reasonably sufficient to permit LUX TV to locate the material.</li>
      ...
      <ul className="text-sm">
        ...
        <li>The subscriber's name, address, and telephone number, and a statement that the subscriber consents to the jurisdiction of Federal District Court for the judicial district in which the address is located, or if the subscriber's address is outside of the United States, for any judicial district in which LUX TV may be found, and that the subscriber will accept service of process from the person who provided notification under subsection (c)(1)(C) or an agent of such person.</li>
      </ul>
      <h3><strong> DESIGNATED COPYRIGHT AGENT</strong></h3>
      <span className="text-sm">All notifications of claimed infringement with respect to LUX TV’s website or the LUX TV service should be sent to: <a className="text-blue-500 underline" href="mailto:copyright@netflytv.com">copyright@netflytv.com</a></span>
      <span className="text-sm">For clarity, only DMCA notices should go to the LUX TV Designated Copyright Agent. Any other feedback, comments, requests for technical support or other communications should be directed to LUX TV customer service through the LUX TV Contact Center. You acknowledge that if you fail to comply with all of the requirements of this section, your DMCA notice may not be valid.</span>
    </div>
  </div>
</main>
