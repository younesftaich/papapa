...
<span>Order Now</span>
 ...
 <a onClick={ () => togglePrice() }  className="   block py-2 px-4 text-sm  font-medium font-sans text-black hover:text-primary transition-colors">Contact Us</a>
    ...
    <a x-show="showShadow" href={'/'} className="   block py-2 px-2 text-sm  font-medium font-sans  cursor-pointer bg-orange-500 hover:bg-orange-600 text-white text-center  border border-transparent rounded-md focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-orange-600 focus:outline-none transition-colors duration-200 leading-6 ">
<span>Order Now</span>
</a>
  </div>
</nav>
  ...
  <div className="box-border flex-grow w-full px-10 pt-8 pb-2 mx-auto leading-6 text-gray-800 lg:pt-16 lg:pb-2 max-w-7xl">
    <div className="relative w-full px-0 mb-12 leading-6 text-left md:text-center lg:flex-grow-0 lg:flex-shrink-0">
      ...
      The #1 Reliable 
        <span className="font-black text-red-600"> lPTV Provider</span>
      </h1>
...
About Us</h2>
    ...
    <div className="flex flex-col mb-8 animated fadeIn sm:flex-row">
      ...
      <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
        <p className="mb-2 text-sm font-semibold leading-none text-left text-red-600 uppercase">PREMIUM STREAMING</p>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 5l7 7-7 7M5 5l7 7-7 7" />
    ...
    <div className=" flex flex-col mb-8 animated fadeIn sm:flex-row">
      ...
      <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pl-16">
        <p className="mb-2 text-sm font-semibold leading-none text-left bg-orange-200 text-red-600 uppercase">AntiFreeze Technology
</p>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 5l7 7-7 7M5 5l7 7-7 7" />
    ...
    <div className="flex flex-col mb-8 animated fadeIn sm:flex-row">
      ...
      <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
        <p className="mb-2 text-sm font-semibold leading-none text-left text-red-600 uppercase">Working on all operating systems</p>
  ...
  <div className="max-w-6xl px-12 mx-auto bg-gray-100 md:px-16 xl:px-10">
    <div className="flex flex-col items-center lg:flex-row">
      <div className="flex flex-col items-start justify-center w-full h-full pr-8 mb-10 lg:mb-0 lg:w-1/2">
        <p className="mb-2 text-base font-medium tracking-tight text-red-500 uppercase">Our customers love our product</p>
        ...
        <blockquote className="flex items-center justify-between w-full col-span-1 p-6 bg-white rounded-lg shadow">
          <div className="flex flex-col pr-8">
            <div className="relative pl-12">
              <svg className="absolute left-0 w-10 h-10 text-red-500 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 125">
